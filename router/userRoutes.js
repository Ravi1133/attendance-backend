...
const { addRole, userAdd, userLogin, markAttendence, getAllRoles, getAllUser, addClient, getClient, getAttendenceData, updateClientStatus, updateUserStatus, changePassword, updateClient, userUpdate } = require("../controller/userController")
const { validateRole, validateUser, validateAttendence, validateClient, validateClientFetch, checkAttendanceDataSchema, validateCheckAttendence, validateCheckChangePassword, validateUpdateClient, validateUpdateUser } = require("../util/validators")
...
userRouter.put("/updateUser/:id" ,validateUpdateUser,userUpdate)
...
userRouter.put("/updateClient/:id",validateUpdateClient,updateClient)
